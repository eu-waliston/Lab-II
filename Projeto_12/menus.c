...
void menuPrincipal(ListaDisp* dispositivos, FilaEventos* fila) {
    ...
    do {
        limparTela(); 
        printf("\n===== MENU PRINCIPAL =====\n");
        printf("1. Opções de dispositivo\n");
        printf("2. Opções de sensor/acionador\n");
        printf("3. Opções de evento\n");
        printf("0. Sair\n");
    ...
    do {
        ...
        switch (opcao) {
            ...
            case 4: {
                ...
                printf("Digite 2 para buscar por descrição: \n");
                scanf("%d", &valor);
                if(valor == 1) {
                    printf("Digite o ID: ");
                    scanf("%d", &valorId);
            ...
            case 5:
                ...
                break;
            case 0:
                menuPrincipal(dispositivos, NULL);
                break;
            default:
                printf("Opção inválida!\n");
        }
    ...
    do {
        ...
        switch (opcao) {
            case 1:
                ...
                break;
            case 2:
                listarEventos(fila, dispositivos);
                break;
            case 3:
                //executarProximoEvento(fila, dispositivos);
                break;
            case 0:
